...
pub fn run() {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        shortcut::change_connector_send_system_prompt_setting,
        shortcut::change_connector_send_selection_system_prompt_setting,
        shortcut::change_connector_send_selection_user_prompt_setting,
